...
/// @notice it tells the "Casino" contract to use "Oraclize".
contract Casino is usingOraclize {
    ...
    function bet(uint256 numberToBet) payable {
    ...
    function __callback(
        ...
        numberWinner = ((uint256(sha3(_result)) % 10) + 1);
        distributePrizes();
    }
